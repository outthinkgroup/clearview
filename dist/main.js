...
},{}],"scripts/mobile-navigation.js":[function(require,module,exports) {
/*
...
function mobileNavigationScript() {
  var mobileBtn = document.querySelector(".menu-toggle");
  var headContainer = document.querySelector(".main-header-container");
  ...
  function setMobilMenuOpenState() {
    var state = this.classList.contains("toggled") ? "open" : "closed";
...
},{"./subnav-animate":"scripts/subnav-animate.js","./single-feature-sidebar":"scripts/single-feature-sidebar.js","./mobile-navigation":"scripts/mobile-navigation.js"}],"main.js":[function(require,module,exports) {
"use strict";
